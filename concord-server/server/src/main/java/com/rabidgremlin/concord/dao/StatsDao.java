...
public interface StatsDao
{
    ...
    /**
     * Returns the count of votes made per user,
     * for phrases which have been marked complete with the same label the user voted for.
     */
    ...
    /**
     * Returns the total count of votes made per user,
     * for phrases which have been voted on more or equal times of the margin.
     *
     * @param margin the amount of times a phrase must be voted on to be considered in the query.
     *               Recommend setting to the consensus level.
     */
