            ...
            if (this.props.phraseData) {
                return (
                    <div>
                        ...
                        <div><Typography style={{width: '100%', textAlign: 'center'}} use="headline3" tag="h1"
                                         className="phrase-msg">{this.props.phraseData.phrase}</Typography></div>
                        <Grid>
                                    ...
                                    <Card style={{width: '100%'}}>
                                        <CardPrimaryAction onClick={() => {
                                            ...
                                            <div style={{padding: '0 1rem 1rem 1rem'}}>
                                                <Typography use="headline6" tag="h2">{label.label} - <FormattedNumber
                                                    value={label.score * 100} minimumFractionDigits={2}/>%</Typography>
                                                <Typography
                                                    use="subtitle2"
                                                    tag="h3"
                                                ...
                                                <Typography use="body1" tag="div" theme="text-secondary-on-background"
                                                            ...
                                                            }}>{label.longDescription}</Typography>
                                            </div>
                                        </CardPrimaryAction>
                            ...
                            <GridCell span="3" phone="4" tablet="2" desktop="4" key={"searchbar"}>
                                <Card style={{minWidth: '300px'}} onClick={() => {
                                    this.setState({currentLabel: null})
                                }}>
